    ...
    <div id="productCarousel" class="carousel slide mt-3" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Img_carrossel01.png" class="d-block w-100" alt="Primeira Imagem">
            </div>
            <div class="carousel-item">
                <img src="img/Img_carrossel02.png" class="d-block w-100" alt="Segunda Imagem">
            </div>
            <div class="carousel-item">
                <img src="img/Img_carrossel03.png" class="d-block w-100" alt="Terceira Imagem">
            </div>
        </div>
